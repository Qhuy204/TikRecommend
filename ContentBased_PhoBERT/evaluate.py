"""
Evaluation Script for PhoBERT Content-Based Recommender
...
def compute_metrics(
    recommender: PhoBERTRecommender,
    data: ProcessedData,
...
def main():
    ...
    print("=" * 50)
    print("PhoBERT Content-Based Evaluation")
    print("=" * 50)
    ...
    print_metrics(metrics, "PhoBERT Results")
